...
urlpatterns = [
    ...
    path('details/vote/<uuid:moc>/<uuid:eventcategory>/',
         MocFanVote.as_view(), name='vote'),
    path('details/vote/delete/<uuid:pk>',
         MocDeleteVoteView.as_view(), name='vote_delete'),
    path('details/vote/public/<uuid:moc>/<uuid:eventcategory>/',
         MocPublicVote.as_view(), name='public_vote'),
