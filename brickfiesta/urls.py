...
urlpatterns = [
    ...
    path('privacy_policy/', TemplateView.as_view(template_name='brickfiesta/privacy_policy.html'),
         name='privacy_policy'),
    path('afol/password_reset_done', auth_views.PasswordResetDoneView.as_view(),
         name='password_reset_done'),
    path('afol/password_reset_complete', auth_views.PasswordResetCompleteView.as_view(),
         name='password_reset_complete'),
    path('afol/password_change_done', auth_views.PasswordChangeDoneView.as_view(),
